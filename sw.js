const CACHE = 'grassi-shell-v31';
const CORE = [
  './', './index.html', './pdv.html', './styles.css?v=31', './config.js?v=17',
  './backend.js?v=30', './app.js?v=31', './document-studio.js?v=28', './pwa.js?v=17', './import-wizard.js?v=18', './pdv-experience.js?v=18', './manifest.webmanifest',
