const CACHE = 'grassi-shell-v44';
const CORE = [
  './', './index.html', './pdv.html', './styles.css?v=36', './config.js?v=17',
  './backend.js?v=30', './app.js?v=38', './document-studio.js?v=31', './pwa.js?v=17', './import-wizard.js?v=18', './pdv-experience.js?v=25', './manifest.webmanifest',
