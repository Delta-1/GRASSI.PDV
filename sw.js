const CACHE = 'grassi-shell-v20';
const CORE = [
  './', './index.html', './pdv.html', './styles.css?v=20', './config.js?v=17',
  './backend.js?v=20', './app.js?v=20', './pwa.js?v=17', './import-wizard.js?v=18', './pdv-experience.js?v=18', './manifest.webmanifest',
